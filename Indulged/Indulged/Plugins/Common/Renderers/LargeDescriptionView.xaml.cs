...
{
    public partial class LargeDescriptionView : UserControl
    {
        public static readonly DependencyProperty PhotoSourceProperty = DependencyProperty.Register("PhotoSource", typeof(Photo), typeof(LargeDescriptionView), new PropertyMetadata(OnPhotoSourcePropertyChanged));
        ...
        {
            ((LargeDescriptionView)sender).OnPhotoSourceChanged();
        }
