...
{
    public partial class DiscoveryPhotoRenderer : PhotoRendererBase
    {
        public DiscoveryPhotoRenderer()
        {
            InitializeComponent();
        }
        ...
        protected override void OnPhotoSourceChanged()
        {
            ...
            ImageView.Source = new BitmapImage { UriSource = new Uri(PhotoSource.GetImageUrl()), DecodePixelWidth = 600 };
        ...
        private void ImageView_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            ...
            string collectionContext = PolicyKit.DiscoveryStream;
