...
namespace Indulged.Plugins.ProCam
{
    public partial class ProCamPage
    {
        ...
        private void PerformFocusAnimation(Windows.Foundation.Point? pt)
        {
            ...
            Storyboard.SetTargetProperty(xAnimation, new PropertyPath("(UIElement.RenderTransform).(CompositeTransform.ScaleX)"));
            ...
            Storyboard.SetTargetProperty(yAnimation, new PropertyPath("(UIElement.RenderTransform).(CompositeTransform.ScaleY)"));
            ...
            sb.Completed += (sender, e) => {
                ...
                Storyboard.SetTargetProperty(blinkAnimation, new PropertyPath("(UIElement.Opacity)"));
        ...
        private void PerformFocusLockedAnimation()
        {
            ...
            Storyboard.SetTargetProperty(opactiyAnimation, new PropertyPath("(UIElement.Opacity)"));
